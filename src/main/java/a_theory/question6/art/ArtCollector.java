...
public class ArtCollector {
    ...
    //for question 6 there are 4 assignments in total
    ...
    //create a working api for an art collector
    ...
    public List<Painting> getPage(int page) {return List.of();}
    public List<Painting> getPage(int page, int resultsPerPage) {return List.of();}

    public List<List<Painting>> getPages(int start, int end) {return List.of(List.of());}
    public List<List<Painting>> getPages(int start, int end, int resultsPerPage) {return List.of(List.of());}

    // To my gallery I always add new paintings. One or two a week. I have a good business in town.
    public void addPainting(Painting painting) {paintings.add(painting);}
    ...
    public String getDetails(Painting painting) {return "";}
